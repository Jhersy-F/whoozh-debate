...
>(({ className, trackClassName, rangeClassName, thumbClassName, ...props }, ref) => (
  <SliderPrimitive.Root
    ref={ref}
    className={cn(
      "relative flex w-full touch-none select-none items-center h-2",
      className
    )}
    {...props}
  >
    <SliderPrimitive.Track className={cn("relative h-full w-full grow overflow-hidden rounded-full bg-muted", trackClassName)}>
